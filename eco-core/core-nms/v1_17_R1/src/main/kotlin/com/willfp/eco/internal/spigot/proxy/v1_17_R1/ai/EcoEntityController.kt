...
import com.willfp.eco.core.entities.ai.goals.PrioritizedGoal
...
class EcoEntityController<T : Mob>(
    ...
    override fun getEntityGoals(): Set<PrioritizedGoal<EntityGoal>> {
        val nms = getNms() ?: return emptySet()
        return nms.goalSelector.availableGoals.map {
    ...
    override fun removeTargetGoal(goal: EntityGoal): EntityController<T> {
        val nms = getNms() ?: return this
